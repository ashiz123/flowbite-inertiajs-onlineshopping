...
export default function filter({filteredProduct}) {
  ...
  const handleFilterClick = (filter) => {
    router.get('/shop/filterBy/?search=' + filter);
    }
  ...
  <div>
    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Filtered Products</h1>

        <div class="flex items-center">
          <div class="relative inline-block text-left">
            <div>
              <button type="button" onClick={toggleVisible} class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true">
                Sort
            ...
            --> */}
            <div className = {` transition transform ${isVisible ? 'ease-out duration-100  opacity-100 scale-100' : ' ease-in duration-75 opacity-0 scale-95'} absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none" `} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
      ...
      <section aria-labelledby="products-heading" class="pb-24 pt-6">
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
          ...
          <form class="hidden lg:block">
            ...
            <li>
            <a href="#" onClick={() => handleFilterClick('shoes')}>Shoes</a>
              </li>
              <li>
                <a href="#" onClick={() => handleFilterClick('mens')}>Mens</a>
              </li>
              <li>
                <a href="#" onClick={() => handleFilterClick('tshirt')}>Tshirt</a>
              </li>
              <li>
              <a href="#" onClick={() => handleFilterClick('womens')}>Womens</a>
              </li>
              <li>
              <a href="#" onClick={() => handleFilterClick('bag')}>Bags</a>
              </li>
              <li>
              <a href="#" onClick={() => handleFilterClick('electronic')}>Electronics</a>
              </li>
            </ul>
              ...
              <div class="pt-6" id="filter-section-1">
                <div class="space-y-4">
                  <div class="flex items-center">
                    ...
                    <label for="filter-category-0" class="ml-3 text-sm text-gray-600">Filter Products</label>
                  </div>
                  <div class="flex items-center">
